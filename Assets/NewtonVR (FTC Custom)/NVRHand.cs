...
namespace NewtonVR
{
    public class NVRHand : MonoBehaviour, INVRHand
    {
		private Valve.VR.EVRButtonId HoldButton = Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger;
		public bool HoldButtonDown { get; set; }
		public bool HoldButtonUp { get; set; }
		public bool HoldButtonPressed { get; set; }

		private Valve.VR.EVRButtonId UseButton = Valve.VR.EVRButtonId.k_EButton_SteamVR_Touchpad;
		public bool UseButtonDown { get; set; }
		public bool UseButtonUp { get; set; }
		public bool UseButtonPressed { get; set; }

		private Valve.VR.EVRButtonId MenuButton = Valve.VR.EVRButtonId.k_EButton_ApplicationMenu;
		public bool MenuButtonDown { get; set; }
		public bool MenuButtonUp { get; set; }
		public bool MenuButtonPressed { get; set; }

		public void TriggerHapticPulse (ushort duration) {
			if (Controller != null) {
				Controller.TriggerHapticPulse (duration, Valve.VR.EVRButtonId.k_EButton_SteamVR_Touchpad);
			}
		}
